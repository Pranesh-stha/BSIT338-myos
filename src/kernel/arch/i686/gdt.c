...
typedef struct {
    ...
    GDTEntry* Ptr;           // address of the table
...
// helpers to slice base/limit into the descriptor's scattered fields
...
GDTEntry g_GDT[] = {
    ...
    // 32-bit code segment: base 0, full 4GB, ring 0
    GDT_ENTRY(0, 0xFFFFF,
        GDT_ACCESS_PRESENT | GDT_ACCESS_RING0 | GDT_ACCESS_CODE_SEGMENT | GDT_ACCESS_CODE_READABLE,
        GDT_FLAG_32BIT | GDT_FLAG_GRANULARITY_4K),

    // 32-bit data segment: base 0, full 4GB, ring 0
    GDT_ENTRY(0, 0xFFFFF,
